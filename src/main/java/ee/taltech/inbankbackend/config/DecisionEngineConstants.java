...
public class DecisionEngineConstants {
    ...
    public static final Integer MAXIMUM_LOAN_PERIOD_IN_YEARS = MAXIMUM_LOAN_PERIOD / 12;
    ...
    public static final int MINIMUM_ELIGIBLE_AGE = 18;
    public static final int MAXIMUM_EXPECTED_LIFETIME = 85;
}
